...
###
# Select anchor features using seurat to use in the integration of datasets
###

# Integration of the replicates - find features from the datasets to anchor cells from different sources
anchFeatures <- SelectIntegrationFeatures(object.list = list(OX_1E, OX_2E, OX_3E, COL_1E))
...
# Set highly variable genes - identified using the Seurat approach for all the replicates across both species
