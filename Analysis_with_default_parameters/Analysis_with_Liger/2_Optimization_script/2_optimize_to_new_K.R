...
optimize_to_new_k(optimized_liger_object = "/netscratch/dep_tsiantis/grp_laurent/tamal/2024/scRNA_projects/comparative_study_of_APEX_between_two_species/Analysis_with_default_parameters/Analysis_with_Liger/01_Data_preprocessing_and_integration/integrated_species_SAM_liger.RData", 
